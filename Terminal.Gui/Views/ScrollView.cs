...
namespace Terminal.Gui {
	...
	public class ScrollView : View {
		...
		public ScrollView(Rect frame) : base(frame)
		{
			...
			vertical = new ScrollBarView(new Rect(frame.Width - 1, 0, 1, frame.Height), frame.Height, 0, true);
			vertical.ChangedPosition += delegate { ContentOffset = new Point(ContentOffset.X, vertical.Position); };
			horizontal = new ScrollBarView(new Rect(0, frame.Height - 1, frame.Width - 1, 1), frame.Width - 1, 0, false);
